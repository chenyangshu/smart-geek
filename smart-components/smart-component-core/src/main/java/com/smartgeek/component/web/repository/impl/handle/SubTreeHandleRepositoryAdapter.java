...
import com.smartgeek.component.web.repository.impl.TreeRepositoryAdapter;
 ...
 * @author xueyi
 */
public abstract class SubTreeHandleRepositoryAdapter<Q extends P, D extends P, P extends SubTreeEntity<D, SD>, PM extends SubTreeMapper<Q, D, P, SQ, SD, SP>, CT extends BaseConverter<Q, D, P>, SQ extends SP, SD extends SP, SP extends BaseEntity, SPM extends BaseMapper<SQ, SD, SP>, SCT extends BaseConverter<SQ, SD, SP>> extends TreeRepositoryAdapter<Q, D, P, PM, CT> {
